...
export default function PositionPage({ positions, groups }: Props) {
    ...
    const onEdit = (record: Maintenance) => {
        ...
        setDialogDescription(
            `Make changes to this position. Click save when you're done.`,
        );
        setData({
            id: String(record.id),
            name: record.name,
    ...
    return (
        <div className="space-y-4 p-4">
            ...
            <ConfirmDialog
                ...
                description="This will permanently delete this position record. This action cannot be undone."
                confirmText="Delete"
                onConfirm={async () => {
                    if (pendingDeleteId !== null) {
                        triggerUndoable(pendingDeleteId, {
                            action: onDelete,
                            message: 'Position will be deleted',
